************************************************************************
*                                                                      *
      SUBROUTINE LDCSL1 (NCORER,FILNAM)
*                                                                      *
...
*
      ...
      STATUS = 'OLD'
*
*   Determine the name of the first  .csl  file (we now pass if from the
*   main program)
*
      NFIRST = 0

    1 IF (NFIRST.NE.0) THEN
...
*
     ...
     :    (RECORD(1:15) .NE. 'Core subshells:')) THEN
         PRINT *, trim(FILNAM),' Not a Configuration Symmetry List File'
         CLOSE (21)
         GOTO 1
      ENDIF
*
