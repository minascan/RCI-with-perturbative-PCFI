...
C         CALL MPI_Bcast (C, 1, MPI_DOUBLE_PRECISION, 0,
...
C         CALL MPI_Bcast (YES, 1, L_MPI, 0, MPI_COMM_WORLD, ierr)
...
C               READ *, N
C            ENDIF
C            CALL MPI_Bcast (RNT, 1, MPI_DOUBLE_PRECISION, 0,
C     &                          MPI_COMM_WORLD, ierr)
C            CALL MPI_Bcast (H, 1, MPI_DOUBLE_PRECISION, 0,
C     &                          MPI_COMM_WORLD, ierr)
C            CALL MPI_Bcast (HP, 1, MPI_DOUBLE_PRECISION, 0,
C     &                          MPI_COMM_WORLD, ierr)
C            CALL MPI_Bcast (N, 1, I_MPI, 0, MPI_COMM_WORLD, ierr)
C         ENDIF
C      ENDIF
*
